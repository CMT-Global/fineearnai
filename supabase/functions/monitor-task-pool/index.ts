...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const health = healthData as TaskPoolHealth;
    ...
    const { error: metricsError } = await supabase
      ...
      .insert({
        ...
        alert_message: health.health_status === 'critical' || health.health_status === 'warning' 
