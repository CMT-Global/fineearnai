-- Phase 2: Fix referral_earnings earning_type to satisfy CHECK constraint
-- Issue: complete_task_atomic inserts earning_type 'task_completion' which violates
--        referral_earnings_earning_type_check. Use 'task_earning' instead.
    ...
    IF v_referral.id IS NOT NULL THEN
      ...
      IF v_referrer_plan.id IS NOT NULL THEN
        ...
        IF v_commission_rate > 0 THEN
          ...
          -- Insert referral_earnings record (FIXED earning_type)
          INSERT INTO referral_earnings (
            ...
            p_user_id,
            'task_earning', -- FIX: previously 'task_completion'
            p_earnings_amount,
            v_commission_rate,
            v_commission_amount,
            jsonb_build_object(
