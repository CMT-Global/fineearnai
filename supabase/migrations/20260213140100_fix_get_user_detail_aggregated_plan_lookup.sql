-- Fix: plan_info was NULL when profile.membership_plan is NULL/empty (admin showed "Unknown", 0 tasks).
-- Resolve plan lookup using 'free' when membership_plan is null or empty.
