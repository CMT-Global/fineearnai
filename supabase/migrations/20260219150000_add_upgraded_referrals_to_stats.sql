-- ============================================
-- Add upgraded_referrals to get_referral_stats
-- Only referrals whose referred user is on a paid plan (account_type <> 'free') count.
-- Free/trainee referrals are unlimited; max_active_referrals in plans applies to upgraded only.
-- ============================================
...
'Returns referral statistics for a user. upgraded_referrals = count of referrals on a paid plan (account_type <> free). Always returns exactly one row.';
