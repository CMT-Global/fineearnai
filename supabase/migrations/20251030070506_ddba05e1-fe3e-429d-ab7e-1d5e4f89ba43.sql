-- Phase 2: Implement Free Plan Expiry Logic
-- Update handle_new_user() to set plan_expires_at for free plans based on free_plan_expiry_days
...
BEGIN
  ...
  -- Insert profile with plan_expires_at set
