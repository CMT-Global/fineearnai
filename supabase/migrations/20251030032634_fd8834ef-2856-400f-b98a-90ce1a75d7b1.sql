...
-- Verify the function returns commission data properly
-- The function already has commission logic, but let's ensure it's deployed
...
BEGIN
  ...
  WHERE referred_id = p_user_id AND status = 'active' LIMIT 1;
