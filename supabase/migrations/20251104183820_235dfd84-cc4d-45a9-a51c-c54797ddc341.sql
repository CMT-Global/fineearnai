-- PHASE 1: SURGICAL FIX TO credit_deposit_atomic_v2
-- Fix deposit commission failures by matching the working task commission logic
...
BEGIN
  ...
  IF v_referral IS NOT NULL THEN
    ...
    -- 🔧 PHASE 1 FIX #1: Add is_active filter to match working task commission logic
    ...
    -- 🔧 PHASE 1 FIX #2: Use field-level NULL check to match working task commission logic
