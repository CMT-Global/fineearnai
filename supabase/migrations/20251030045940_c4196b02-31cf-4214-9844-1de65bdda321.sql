-- Phase 1: Fix get_user_detail_aggregated() function to correctly fetch upline information
-- This ensures the function uses the referrals table as the source of truth for upline data
