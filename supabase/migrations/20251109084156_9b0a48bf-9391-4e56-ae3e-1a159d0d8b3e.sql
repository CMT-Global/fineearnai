-- PHASE 1: Fix critical column name bug in process_deposit_commission_simple_v1
-- Change last_commission_at to last_commission_date (line 170 of function)
...
BEGIN
  ...
  -- Step 9: Update referral stats with FIXED column name
  -- BUG FIX: Changed from last_commission_at to last_commission_date
  UPDATE referrals
  SET 
