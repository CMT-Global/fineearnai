...
export const UserManagementStats = ({ stats, isLoading }: UserManagementStatsProps) => {
  ...
  const statCards = [
    ...
    },
    {
      ...
      icon: UserCheck,
      description: `${((stats?.active_users / stats?.total_users) * 100 || 0).toFixed(1)}% of total`,
    ...
    },
    {
      ...
      icon: Activity,
      description: "Total referral network",
      color: "text-teal-600",
    },
    {
      title: "Paid Plans",
      ...
      icon: TrendingUp,
      description: `${stats?.paid_plan_users?.toLocaleString() || "0"} users`,
